...
void plotCMEResults_differential_diff_scaleByVn(){
...
//end of figure1
    ...
    TH1D* base2 = makeHist("base2", "", "|#Delta#eta|", "v_{2}#delta(os-ss)", 48,0,4.8,kBlack);
	base2->GetYaxis()->SetRangeUser(-0.0005,0.0012);
