#ifndef CMEandMixedHarmonicsBase_
#define CMEandMixedHarmonicsBase_
...
class CMEandMixedHarmonics : public edm::EDAnalyzer {
   public:
      explicit CMEandMixedHarmonics(const edm::ParameterSet&);
      ~CMEandMixedHarmonics();
