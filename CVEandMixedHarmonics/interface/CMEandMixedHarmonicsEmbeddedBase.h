#ifndef CMEandMixedHarmonicsEmbeddedBase_
#define CMEandMixedHarmonicsEmbeddedBase_
...
class CMEandMixedHarmonicsEmbedded : public edm::EDAnalyzer {
   public:
      explicit CMEandMixedHarmonicsEmbedded(const edm::ParameterSet&);
      ~CMEandMixedHarmonicsEmbedded();
   ...
   private:
      ...
      TH1D* c2_real[36][48][3];
      TH1D* c2_imag[36][48][3];

      TH1D* c3_real[36][48][3][2];
      TH1D* c3_imag[36][48][3][2];
      //eta
