#ifndef CMERoyLaceyCorrelatorBase_
#define CMERoyLaceyCorrelatorBase_
...
class CMERoyLaceyCorrelator : public edm::EDAnalyzer {
   public:
      explicit CMERoyLaceyCorrelator(const edm::ParameterSet&);
      ~CMERoyLaceyCorrelator();
