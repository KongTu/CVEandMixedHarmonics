...
vector<double> ks_YieldCal( TH1D* inputHist ){
...
//
    ...
    fitResult.push_back( sigyh );
    
    double fitError = sqrt( totyh + bkgy );

    fitResult.push_back ( fitError );
...
vector<double> la_YieldCal( TH1D* inputHist ){
...
//starting to do RooFit:
    ...
    RooRealVar sigma1("sigma1","sigma1",0.0005,0.0003,0.01);
    RooRealVar sigma2("sigma2","sigma2",0.0005,0.0003,0.01);
    RooRealVar sig1("sig1","signal1",1000,0,10000000);
    RooRealVar sig2("sig2","signal2",1000,0,10000000);
    RooRealVar a("a","a",0,-1000000,1000000);
    RooRealVar b("b","b",0,-1000000,1000000);
    RooRealVar cp("cp","cp",0,-1000000,1000000);
    RooRealVar d("d","d",0,-1000000,1000000);
    RooRealVar e("e","e",0,-1000000,1000000);
    RooRealVar ef("ef","ef",0,-1000000,1000000);
    RooRealVar n("n","n",0,-1000000,1000000);

    RooRealVar f("f","f",0,-1000000,1000000);
    RooRealVar g("g","g",0,-1000000,1000000);
    RooRealVar h("h","h",0,-1000000,1000000);
    RooRealVar k("k","k",0,-1000000,1000000);
    RooRealVar l("l","l",0,-1000000,1000000);
    RooRealVar m("m","m",0,-1000000,1000000);
    RooRealVar o("o","o",0,-1000000,1000000);

    RooGaussian gaus1("gaus1","gaus1",x,mean,sigma1);
    RooGaussian gaus2("gaus2","gaus2",x,mean,sigma2);
    RooPolynomial poly("poly","poly",x,RooArgList(a,b,cp,d,e,ef,n));
    RooRealVar polysig("polysig","polysig",1000000,-10000000,1000000000);
    RooAddPdf sum("sum","sum",RooArgList(gaus1,gaus2,poly),RooArgList(sig1,sig2,polysig));

    x.setRange("cut",1.1,1.13);
